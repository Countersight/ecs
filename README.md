...
| <a name="agent.hostname"></a>agent.hostname | Hostname of the agent. Added by Countersight 2018-12-26 | core | keyword | `host.example.com` |
...
| <a name="countersight.collector.name"></a>countersight.collector.name | The name and instance of collector that received the event. | extended | keyword | `The name provided in the UI for a collector, e.g "my cool collector"` |
| <a name="countersight.collector.type"></a>countersight.collector.type | The type of collector that received the event. | extended | keyword | `cloudtrail` |
...
## <a name="system"></a> System fields

The system fields describe some physical properties of a system, such as device temperatures. Added by Countersight 2019-02-28. 


| Field  | Description  | Level  | Type  | Example  |
|---|---|---|---|---|
| <a name="system.temperature.inlet"></a>system.temperature.inlet | The inlet temperature for a server. | extended | integer | `33` |
| <a name="system.temperature.cpu"></a>system.temperature.cpu | The CPU temperature for a server. | extended | keyword | `55` |
